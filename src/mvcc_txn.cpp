...
namespace {
     ...
     */
    std::pair<util::ByteBuffer, uint64_t> DecodeKeyWithTs(const util::ByteBuffer& versioned_key) {
     ...
     */
    bool VersionedKeyMatches(const util::ByteBuffer& versioned_key, const util::ByteBuffer& user_key) {
